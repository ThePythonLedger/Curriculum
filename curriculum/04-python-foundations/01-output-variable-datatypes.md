...
## Assignment
Try the following excercise to establish your knowlege.
We will define a *shop name* and *item* with varius data types.
1. Create a variable called `shop_name` and set its value to some **string**
2. Create a variable called `item_name` and set its value to some **string**
3. Create a variable called `item_quantity` and set its value to some **integer**
4. Create a variable called `item_price` and set its value to some **float**
5. Create a variable called `item_available` and set its value to some **boolean**
...
Error are very helpful as they tell us exactly **what** is the issue and **where** they happened. If the errors did not exists, your programs would just silently die, and you would have to randomly guess where the issue is.
...
## Assignment
Try the following exercise to establish your knowledge.
We will define a *shop name* and *item* with various data types.
1. Create a variable called `shop_name` and set its value to some **string**
2. Create a variable called `item_name` and set its value to some **string**
3. Create a variable called `item_quantity` and set its value to some **integer**
4. Create a variable called `item_price` and set its value to some **float**
5. Create a variable called `item_available` and set its value to some **boolean**
6. Output all of these variables declared to the screen (you can use multiple print statements) following this format: `<variable name>: <variable value>`
...
1. Learn more about [Strings in Python](https://docs.python.org/3/library/stdtypes.html#text-sequence-type-str) in **Official Python Documentation** and [What is String and its types in Python](https://dev.to/atifwattoo/what-is-string-and-its-types-in-python-4ide) from this article from **dev.to** .
2. Read more about `print()` function from [Your Guide to Python print Function](https://realpython.com/python-print/) from this **RealPython** article.
3. Learn more about [Basic Datatypes in Python](https://realpython.com/python-data-types/) from this **RealPython** article.
